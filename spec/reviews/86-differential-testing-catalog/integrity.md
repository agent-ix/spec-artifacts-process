...
The catalogue census is internally consistent: 22 Test, 9 Analysis, 1
Inspection and 2 Demonstration methods total 34. Each new criterion owns one
...
| FND-002 | medium | Resolved after TC-144 failed on the inherited stale census: the prose total, per-class count, listed names and authoritative map now agree at 34 methods and make the added method visible in both the total and Test class. | FR-007 seed set; TC-048; TC-144 | implementation-bug-despite-evidence |
